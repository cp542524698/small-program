...
Page({
    ...
    onLoad: function (event) {
        ...
        wx.request({
            ...
            success: function (res) {
                ...
                that.setData({ personal: type1 })
                that.setData({ business: type2 })
    ...
    tapName: function (e) {
      ...
      if (id == 0) {
        that.setData({
          carts: that.data.personal
        })
      } else if (id == 1) {
        that.setData({
          carts: that.data.business
        })
      }
      that.setData({
...
/*
    tapName: function (e) {
        ...
        context.moveTo(30, 5);//设置线条的起始路径坐标
        context.lineTo(95, 5);//设置线条的终点路径坐标
